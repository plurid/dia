...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `dia`;
    const descriptionValue = description || 'assemble web content in three dimensions';
    const ogTitleValue = ogTitle || title || `dia`;
    const ogDescriptionValue = ogDescription || description || 'assemble web content in three dimensions';
